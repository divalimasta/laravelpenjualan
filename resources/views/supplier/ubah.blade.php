...
<div class="card card-primary">
            ...
            <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" value="{{$supplier->supplier_alamat}}" name="supplier_nama" class="form-control" id="" placeholder="">
                  </div>
                  <div class="form-group">
                    <label for="">Supplier Phone</label>
                    <input type="text" value="{{$supplier->supplier_phone}}" name="supplier_nama" class="form-control" id="" placeholder="">
                  </div>
                  <div class="form-group">
